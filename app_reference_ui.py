...
def sparkline_svg(
    ...
    <svg
        ...
        role="img"
        aria-label="Last 7 days of actual load"
    >
        <polygon
            points="{area}"
            fill="{BLACK}"
...
if result is None:
    ...
    with tab_chart:
        ...
        section(
            ...
            "Black shows recent actual load and forecast. "
